...
add_parameter LEFT STD_LOGIC_VECTOR 1
set_parameter_property LEFT DEFAULT_VALUE 1
set_parameter_property LEFT DISPLAY_NAME LEFT
set_parameter_property LEFT TYPE STD_LOGIC_VECTOR
set_parameter_property LEFT UNITS None
set_parameter_property LEFT ALLOWED_RANGES 0:7
set_parameter_property LEFT HDL_PARAMETER true
add_parameter RIGHT STD_LOGIC_VECTOR 2
set_parameter_property RIGHT DEFAULT_VALUE 2
set_parameter_property RIGHT DISPLAY_NAME RIGHT
set_parameter_property RIGHT TYPE STD_LOGIC_VECTOR
set_parameter_property RIGHT UNITS None
set_parameter_property RIGHT ALLOWED_RANGES 0:7
set_parameter_property RIGHT HDL_PARAMETER true
...
add_interface_port audio SCK sck Input 1
add_interface_port audio SD sd Input 1
add_interface_port audio WS ws Output 1
