...
module soc_system_mm_interconnect_0 (
		...
		output wire        audio_0_avalon_slave_0_write,                                     //                                                           .write
		output wire        audio_0_avalon_slave_0_read,                                      //                                                           .read
		input  wire [31:0] audio_0_avalon_slave_0_readdata,                                  //                                                           .readdata
		output wire [31:0] audio_0_avalon_slave_0_writedata,                                 //                                                           .writedata
	...
	wire          audio_0_avalon_slave_0_burst_adapter_source0_endofpacket;   // audio_0_avalon_slave_0_burst_adapter:source0_endofpacket -> audio_0_avalon_slave_0_agent:cp_endofpacket
	...
	wire          router_002_src_endofpacket;                                 // router_002:src_endofpacket -> audio_0_avalon_slave_0_rsp_width_adapter:in_endofpacket
	wire          audio_0_avalon_slave_0_rsp_width_adapter_src_valid;         // audio_0_avalon_slave_0_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [158:0] audio_0_avalon_slave_0_rsp_width_adapter_src_data;          // audio_0_avalon_slave_0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          audio_0_avalon_slave_0_rsp_width_adapter_src_ready;         // rsp_demux:sink_ready -> audio_0_avalon_slave_0_rsp_width_adapter:out_ready
	wire    [1:0] audio_0_avalon_slave_0_rsp_width_adapter_src_channel;       // audio_0_avalon_slave_0_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          audio_0_avalon_slave_0_rsp_width_adapter_src_startofpacket; // audio_0_avalon_slave_0_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          audio_0_avalon_slave_0_rsp_width_adapter_src_endofpacket;   // audio_0_avalon_slave_0_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> audio_0_avalon_slave_0_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> audio_0_avalon_slave_0_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // audio_0_avalon_slave_0_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> audio_0_avalon_slave_0_cmd_width_adapter:in_channel
	...
	altera_merlin_slave_translator #(
		...
		.uav_address            (audio_0_avalon_slave_0_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (audio_0_avalon_slave_0_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (audio_0_avalon_slave_0_agent_m0_read),          //                         .read
		.uav_write              (audio_0_avalon_slave_0_agent_m0_write),         //                         .write
		.uav_waitrequest        (audio_0_avalon_slave_0_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (audio_0_avalon_slave_0_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (audio_0_avalon_slave_0_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (audio_0_avalon_slave_0_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (audio_0_avalon_slave_0_agent_m0_writedata),     //                         .writedata
		.uav_lock               (audio_0_avalon_slave_0_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (audio_0_avalon_slave_0_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (audio_0_avalon_slave_0_address),                //      avalon_anti_slave_0.address
		.av_write               (audio_0_avalon_slave_0_write),                  //                         .write
		.av_read                (audio_0_avalon_slave_0_read),                   //                         .read
		.av_readdata            (audio_0_avalon_slave_0_readdata),               //                         .readdata
		.av_writedata           (audio_0_avalon_slave_0_writedata),              //                         .writedata
		.av_chipselect          (audio_0_avalon_slave_0_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_0_avalon_slave_0_agent (
		.clk                     (clk_0_clk_clk),                                              //             clk.clk
		.reset                   (audio_0_reset_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (audio_0_avalon_slave_0_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_0_avalon_slave_0_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_0_avalon_slave_0_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_0_avalon_slave_0_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_0_avalon_slave_0_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_0_avalon_slave_0_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_0_avalon_slave_0_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_0_avalon_slave_0_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_0_avalon_slave_0_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_0_avalon_slave_0_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_0_avalon_slave_0_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_0_avalon_slave_0_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_0_avalon_slave_0_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_0_avalon_slave_0_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_0_avalon_slave_0_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_0_avalon_slave_0_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_0_avalon_slave_0_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_0_avalon_slave_0_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_0_avalon_slave_0_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_0_avalon_slave_0_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_0_avalon_slave_0_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_0_avalon_slave_0_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_0_avalon_slave_0_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_0_avalon_slave_0_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_0_avalon_slave_0_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_0_avalon_slave_0_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_0_avalon_slave_0_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_0_avalon_slave_0_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_0_avalon_slave_0_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_0_avalon_slave_0_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_0_avalon_slave_0_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_0_avalon_slave_0_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                              //                .error
		.rdata_fifo_src_ready    (audio_0_avalon_slave_0_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_0_avalon_slave_0_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_0_avalon_slave_0_agent_rdata_fifo_src_data),           //                .data
	...
	) audio_0_avalon_slave_0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                           //       clk.clk
		.reset             (audio_0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		.in_data           (audio_0_avalon_slave_0_agent_rf_source_data),             //        in.data
		.in_valid          (audio_0_avalon_slave_0_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_0_avalon_slave_0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_0_avalon_slave_0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_0_avalon_slave_0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_0_avalon_slave_0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_0_avalon_slave_0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_0_avalon_slave_0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_0_avalon_slave_0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_0_avalon_slave_0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_0_avalon_slave_0_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (audio_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (audio_0_avalon_slave_0_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (audio_0_avalon_slave_0_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (audio_0_avalon_slave_0_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (audio_0_avalon_slave_0_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (audio_0_avalon_slave_0_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (audio_0_avalon_slave_0_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	soc_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (audio_0_avalon_slave_0_agent_rp_ready),         //      sink.ready
		.sink_valid         (audio_0_avalon_slave_0_agent_rp_valid),         //          .valid
		.sink_data          (audio_0_avalon_slave_0_agent_rp_data),          //          .data
		.sink_startofpacket (audio_0_avalon_slave_0_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (audio_0_avalon_slave_0_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (audio_0_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	) audio_0_avalon_slave_0_burst_adapter (
		.clk                   (clk_0_clk_clk),                                              //       cr0.clk
		.reset                 (audio_0_reset_reset_bridge_in_reset_reset),                  // cr0_reset.reset
		.sink0_valid           (audio_0_avalon_slave_0_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (audio_0_avalon_slave_0_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (audio_0_avalon_slave_0_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (audio_0_avalon_slave_0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (audio_0_avalon_slave_0_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (audio_0_avalon_slave_0_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (audio_0_avalon_slave_0_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_0_avalon_slave_0_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_0_avalon_slave_0_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_0_avalon_slave_0_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_0_avalon_slave_0_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_0_avalon_slave_0_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (audio_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		.sink_ready         (audio_0_avalon_slave_0_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (audio_0_avalon_slave_0_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (audio_0_avalon_slave_0_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (audio_0_avalon_slave_0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (audio_0_avalon_slave_0_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (audio_0_avalon_slave_0_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) audio_0_avalon_slave_0_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                              //       clk.clk
		.reset                (audio_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		...
		.out_endofpacket      (audio_0_avalon_slave_0_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (audio_0_avalon_slave_0_rsp_width_adapter_src_data),          //          .data
		.out_channel          (audio_0_avalon_slave_0_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (audio_0_avalon_slave_0_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (audio_0_avalon_slave_0_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (audio_0_avalon_slave_0_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) audio_0_avalon_slave_0_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                              //       clk.clk
		.reset                (audio_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		...
		.out_endofpacket      (audio_0_avalon_slave_0_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (audio_0_avalon_slave_0_cmd_width_adapter_src_data),          //          .data
		.out_channel          (audio_0_avalon_slave_0_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (audio_0_avalon_slave_0_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (audio_0_avalon_slave_0_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (audio_0_avalon_slave_0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                      // (terminated)
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (audio_0_avalon_slave_0_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (audio_0_avalon_slave_0_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (audio_0_avalon_slave_0_agent_rdata_fifo_out_ready), //         .ready
